  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach(function (item, i) {
      switch (item.nodeName) {
        // оставляет в калькуляторе значения табов(спанов) и селекта
        case 'SPAN':
          state[prop] = i + 1;
          break;
...
/* harmony default export */ __webpack_exports__["default"] = (closeModals);

/***/ }),

/***/ "./src/js/modules/culcScroll.js":
/*!**************************************!*\
  !*** ./src/js/modules/culcScroll.js ***!
  \**************************************/
/*! exports provided: default */
...
function culcScroll() {
  ...
  var scrollWidth = div.offsetWidth - div.clientWidth; // вычисление длины скрола (полная ширина экрана - ширина без скролла)

  div.remove();
  return scrollWidth;
}

/* harmony default export */ __webpack_exports__["default"] = (culcScroll);
...
/* harmony import */ var _closeModals__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./closeModals */ "./src/js/modules/closeModals.js");
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // async говорит, что функции будут выполняться асинхронно, не сразу
            document.querySelector('.status').textContent = message.loading;
            _context.next = 3;
            return regeneratorRuntime.awrap(fetch(url, {
              // в данном случае await, по получению ответа от сервера
              method: 'POST',
              body: data
            }));
    ...
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        var timeOut = setTimeout(function () {
          Object(_closeModals__WEBPACK_IMPORTED_MODULE_6__["default"])();
          formWindow.removeEventListener('click', _closeModals__WEBPACK_IMPORTED_MODULE_6__["default"], false);
        }, 3000);
        formWindow.addEventListener('click', _closeModals__WEBPACK_IMPORTED_MODULE_6__["default"], false);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _closeModals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./closeModals */ "./src/js/modules/closeModals.js");
/* harmony import */ var _culcScroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./culcScroll */ "./src/js/modules/culcScroll.js");
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var requiredInputsSelector = arguments.length > 4 ? arguments[4] : undefined;
    //closeClickOverlay если true, нажатие на подложку закрывает модальное окно 
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        modal.removeEventListener('click', _closeModals__WEBPACK_IMPORTED_MODULE_1__["default"], false);

        if (requiredInputs.length > 0) {
          // проверка на заполнение Inputs
          var permitlength = 0;
          requiredInputs.forEach(function (item) {
            switch (item.nodeName) {
              // switch для дальнейшего функционала
              case 'INPUT':
                if (item.getAttribute('type') === 'checkbox') {
                  if (item.checked) {
                    openWindow();
    ...
    close.addEventListener('click', function () {
      //функция закрытия модального окна на кнопку close
      Object(_closeModals__WEBPACK_IMPORTED_MODULE_1__["default"])();
    });
    ...
    function openWindow() {
      ...
      document.body.classList.add('modal-open'); // document.body.style.marginRight = '20px';

      document.body.style.marginRight = "".concat(Object(_culcScroll__WEBPACK_IMPORTED_MODULE_2__["default"])(), "px");
    }
  }
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var displayStyle = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
